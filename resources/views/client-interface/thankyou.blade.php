      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsFurni">
          <ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
            <li class="nav-item">
              <a class="nav-link" href="{{url('/client_home')}}">Home</a>
            </li>
            <li><a class="nav-link" href="{{url('/client_shop')}}">Shop</a></li>
            <li><a class="nav-link" href="{{url('/client_about')}}">About us</a></li>
            <li><a class="nav-link" href="{{url('/client_service')}}">Services</a></li>
            <li><a class="nav-link" href="blog.html">Blog</a></li>
            <li><a class="nav-link" href="{{url('/client_contact')}}">Contact us</a></li>
          </ul>
